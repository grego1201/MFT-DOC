\section{Iteración 5: Creación \acs{BBDD} y extración conocimiento}
...
A continuación en la \hyperref[tab:Ejemplo BBDD inicial iteracion5]{tabla 5.9} se puede ver un ejemplo del estado inicial de la \acs{BBDD}.
