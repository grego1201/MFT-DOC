...
consultar en el siguiente enlace \url{https://github.com/grego1201/MFT-API} o en la \hyperref[fig:Código QR repositorio api]{figura 5.10}.
...
se queda de la siguiente forma (ver \hyperref[tab:Estructura BBDD Inicial iteracion5]{tabla 5.7}):
...
A continuación en la \hyperref[tab:Ejemplo BBDD inicial iteracion5]{tabla 5.8} se puede ver un ejemplo del estado inicial de la BBDD.
...
que la estructura se puede ver \hyperref[tab:Estructura BBDD tiradores]{tabla 5.9} y un ejemplo en la \hyperref[tab:Ejemplo BBDD tiradores]{tabla 5.10}.
...
de la BBDD se puede ver en la \hyperref[tab:estructura BBDD final]{tabla 5.11}.
...
se podrá ver en la \hyperref[tab:Estructura campo ganador]{tabla 5.12}. Para la obtención de este campo se exploró
...
Para ello seguiremos la transformación mostrada en la tabla \hyperref[tab:Tabla equivalencias mano]{5.13} y \hyperref[tab:Tabla equivalencias arma]{5.14} para
...
Después de esto la estructura de la BBDD se puede ver en la \hyperref[tab:Estructura BBDD final postproceso]{tabla 5.15}.
...
puede encontrar en la \hyperref[fig:Chuleta decisión algoritmo ML]{figura 5.11}.
...
En la \hyperref[fig:Gráfica obtención K]{figura 5.12} se puede ver la gráfica comparativa.
...
resultado se puede puede observar en la \hyperref[fig:Gráfica obtención leaf size]{figura 5.13}. El resultado que obtuvimos
...
en la \hyperref[fig:Gráfica obtención p]{figura 5.14}.
...
Los parámetros con sus características se podrán consultar en la \hyperref[tab:Parmetros peticion prediccion]{tabla 5.16}.
...
ver en la \hyperref[tab:Tabla objeto atributo y valor victoria]{tabla 5.17}.
...
ver en la \hyperref[fig:Mapa conocimiento arriesgar]{figura 5.15}.
