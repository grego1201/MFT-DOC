\section{Desarrollo}
A continuación se mostrará todo el proceso que se ha seguido para el desarrollo del prototipo
...
los objetivos propuestos en el \hyperref[cap: Introducción y objetivos]{Capítulo 1}. Estas se pueden ver en la \hyperref[fig:Iteraciones]{figura 4.3}.
...
En este apartado se muestra un resumen de la arquitectura del proyecto a alto nivel, ver \hyperref[fig:Arquitectura proyecto]{figura 4.4}, y las herramientas empleadas para el desarrollo del mismo.
...
temporal del proyecto se puede ver en la \hyperref[fig:Linea temporal]{figura 4.5} expuesta a continuación.
...
puede ver en la \hyperref[fig:Linea temporal]{figura 4.5}.
...
en 30€/h. En la \hyperref[tab:Horas del proyecto]{tabla 4.1} se puede ver el coste de cada iteración, por rol y por horas.
...
Por lo que el coste total del proyecto puede verse en la \hyperref[tab:Costes del proyecto]{tabla 4.2}.
