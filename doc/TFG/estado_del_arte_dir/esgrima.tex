...
Ahora pasaremos a explicar por encima en que consiste un asalto de esgrima. Esto fue obtenido de \cite{normativaFIETec}.
...
Una vez que ya sabemos como funciona un asalto de esgrima podemos hablar sobre como funciona una competición
 de esgrima. Esto se puede encontrar con mas detalle en \cite{normativaFIEOrg}. Se explicará el funcionamiento
