...
\documentclass[ 		% Clase del documento
	...
	final,       		% Versión final
  xcolor=table    % Para meter colores en las tablas.
]{book}
...
%\include{./Objetivo}
\include{./introduccion}
\include{./test_viabilidad}
\include{./estado_del_arte_dir/estado_del_arte}
\include{./propuesta}
\include{./desarrollo}
%\include{./evaluacion}
%\include{./Metodologia}
%\include{./Resultados}
\include{./conclusionesdir/conclusiones}
% -------------------------
...
\include{./anexos/AnexoB} % Apéndice B (opcionales)
\include{./anexos/AnexoC} % Apéndice C (opcionales)
\include{./anexos/AnexoD} % Apéndice D (opcionales)
\include{./anexos/AnexoE} % Apéndice E (opcionales)
\include{./anexos/AnexoF} % Apéndice F (opcionales)
\include{./anexos/AnexoG} % Apéndice G (opcionales)
