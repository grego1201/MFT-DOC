...
Para la resoluciónd el proyecto han sido necesarias cinco iteraciones para cubrir
los objetivos propuestos en el Capítulo 1 (Ver figura 5.1).

\begin{figure}[htb]
  \centering
    \includegraphics[width=0.4\linewidth]{Iteraciones}
...
\begin{table}[]
  ...
  \begin{tabular}{|c|c|l|l|}
    ...
    Infraestroctura & Heroku proyect & - & 0€ \\ \hline
