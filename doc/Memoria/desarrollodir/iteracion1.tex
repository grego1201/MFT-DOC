...
preguntas básicsas, las cuales son comunes a la mayoría de procesos de toma de decisiones.
...
\begin{itemize}
  ...
  \item La distancia se valorará según la diferncia de altura entre tiradores y el puño usado
    de cada uno.
  ...
  \item La personalidad del tirador influye en su forma de tirar. Intentar averigüar como es esa persona
    antes de un asalto.
...
\begin{table}[]
  ...
  \begin{tabular}{lll}
    ...
    \multicolumn{1}{l|}{\multirow{4}{*}{Tirador}} & Puño & \{Francés, Anatóico\} \\ \cline{2-3}
